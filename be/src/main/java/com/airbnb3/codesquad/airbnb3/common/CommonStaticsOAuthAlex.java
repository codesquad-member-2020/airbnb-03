...
public class CommonStaticsOAuthAlex {
    public static final String OAUTH_URL = "https://github.com/login/oauth/authorize?client_id=91882bf66676085caab9&scope=user";
    ...
    public static final String REDIRECT_URL = "http://localhost:8080/alex/main/1";
